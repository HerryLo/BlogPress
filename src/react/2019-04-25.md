...
* [没有state或生命周期方法的class](#没有state或生命周期方法的组件)

* [class 和 state](#拥有state状态的class组件)
...
* [将PureComponent转换为React memo](#将purecomponent转换为reactmemo)
...
![png](https://herrylo.github.io/Img/axewcayr0gcyrtqf6kch.png)
...
![](https://herrylo.github.io/Img/qlnjj9e95jy7qb3c4spd.png)
